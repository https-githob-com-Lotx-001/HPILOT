...
class TorqueEstimator(ParameterEstimator):
  def __init__(self, CP, decimated=False):
    ...
    params = Params()
    self.custom_offline_params = params.get_bool("CustomOfflineParams")
    ...
    if self.custom_offline_friction is None or self.custom_offline_lat_accel is None:
      params.put_float("OfflineLatAccel", self.offline_latAccelFactor)
      params.put_float("OfflineFriction", self.offline_friction)

    if params.get_float("LiveLatAccel") is None or params.get_float("LiveFriction") is None:
