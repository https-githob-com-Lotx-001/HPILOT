...
def create_accel_command(packer, accel, accel_raw, pcm_cancel, standstill_req, lead, acc_type, fcw_alert, distance, hpilot_variables):
  ...
  values = {
    ...
    "ALLOW_LONG_PRESS": 2 if hpilot_variables.reverse_cruise_increase else 1,
