...
class CarState(CarStateBase):
  ...
  def update(self, pt_cp, cam_cp, ext_cp, trans_type, hpilot_variables):
    if self.CP.flags & VolkswagenFlags.PQ:
      return self.update_pq(pt_cp, cam_cp, ext_cp, trans_type, hpilot_variables)
  ...
  def update_pq(self, pt_cp, cam_cp, ext_cp, trans_type, hpilot_variables):
    ret = car.CarState.new_message()
    # Update vehicle speed and acceleration from ABS wheel speeds.
    ret.wheelSpeeds = self.get_wheel_speeds(
