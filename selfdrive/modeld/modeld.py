...
from openpilot.selfdrive.hpilot.controls.lib.model_manager import DEFAULT_MODEL, MODELS_PATH, NAVIGATIONLESS_MODELS, RADARLESS_MODELS
...
def main(demo=False):
  ...
  sm = SubMaster(["deviceState", "carState", "roadCameraState", "liveCalibration", "driverMonitoringState", "navModel", "navInstruction", "carControl", "liveTracks", "hpilotPlan"])
  ...
  while True:
    ...
    if model_output is not None:
      ...
      DH.update(sm['carState'], sm['carControl'].latActive, lane_change_prob, sm['hpilotPlan'])
