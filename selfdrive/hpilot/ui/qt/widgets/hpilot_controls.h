...
class HpilotConfirmationDialog : public ConfirmationDialog {
  Q_OBJECT

public:
  explicit HpilotConfirmationDialog(const QString &prompt_text, const QString &confirm_text,
...
class HpilotListWidget : public QWidget {
  Q_OBJECT
public:
  explicit HpilotListWidget(QWidget *parent = nullptr) : QWidget(parent), outer_layout(this) {
...
class HpilotDualParamControl : public QFrame {
  Q_OBJECT

public:
  HpilotDualParamControl(ParamControl *control1, ParamControl *control2, QWidget *parent = nullptr, bool split=false)
    : QFrame(parent) {
...
class HpilotButtonControl : public AbstractControl {
  Q_OBJECT

public:
  HpilotButtonControl(const QString &title, const QString &text, const QString &desc = "", QWidget *parent = nullptr);
...
class HpilotButtonIconControl : public AbstractControl {
  Q_OBJECT

public:
  HpilotButtonIconControl(const QString &title, const QString &text, const QString &desc = "", const QString &icon = "", QWidget *parent = nullptr);
  inline void setText(const QString &text) { btn.setText(text); }
  inline QString text() const { return btn.text(); }
...
class HpilotButtonParamControl : public ParamControl {
  Q_OBJECT
public:
  HpilotButtonParamControl(const QString &param, const QString &title, const QString &desc, const QString &icon,
...
class HpilotButtonsControl : public ParamControl {
  Q_OBJECT
public:
  HpilotButtonsControl(const QString &title, const QString &desc, const QString &icon,
                          const std::vector<QString> &button_texts, const int minimum_button_width = 225)
...
class HpilotButtonsParamControl : public ParamControl {
  Q_OBJECT
public:
  HpilotButtonsParamControl(const QString &param, const QString &title, const QString &desc, const QString &icon,
...
class HpilotParamManageControl : public ParamControl {
  Q_OBJECT

public:
  HpilotParamManageControl(const QString &param, const QString &title, const QString &desc, const QString &icon, QWidget *parent = nullptr, bool hideToggle = false)
    ...
    connect(manageButton, &ButtonControl::clicked, this, &HpilotParamManageControl::manageButtonClicked);
...
class HpilotParamToggleControl : public ParamControl {
  Q_OBJECT
public:
  HpilotParamToggleControl(const QString &param, const QString &title, const QString &desc,
...
class HpilotParamValueControl : public ParamControl {
  Q_OBJECT

public:
  HpilotParamValueControl(const QString &param, const QString &title, const QString &desc, const QString &icon,
    ...
    connect(countdownTimer, &QTimer::timeout, this, &HpilotParamValueControl::handleTimeout);
    ...
    connect(decrementButton, &QPushButton::released, this, &HpilotParamValueControl::restartTimer);
    connect(incrementButton, &QPushButton::released, this, &HpilotParamValueControl::restartTimer);
...
class HpilotParamValueToggleControl : public HpilotParamValueControl {
  Q_OBJECT

public:
  HpilotParamValueToggleControl(const QString &param, const QString &title, const QString &desc, const QString &icon,
                                   const float &minValue, const float &maxValue, const std::map<int, QString> &valueLabels,
                                   QWidget *parent = nullptr, const bool &loop = true, const QString &label = "",
                                   const float &division = 1.0f, const float &interval = 1.0f,
                                   const std::vector<QString> &button_params = std::vector<QString>(), const std::vector<QString> &button_texts = std::vector<QString>(),
                                   const int minimum_button_width = 225)
      : HpilotParamValueControl(param, title, desc, icon, minValue, maxValue, valueLabels, parent, loop, label, division, interval) {
  ...
  void refresh() {
    HpilotParamValueControl::refresh();
