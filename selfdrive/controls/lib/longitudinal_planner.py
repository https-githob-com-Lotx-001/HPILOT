...
class LongitudinalPlanner:
  ...
  def update(self, sm):
    ...
    self.mpc.update(self.lead_one, self.lead_two, sm['hpilotPlan'].vCruise, x, v, a, j, self.radarless_model, sm['hpilotPlan'].tFollow,
                    sm['hpilotCarControl'].trafficModeActive, personality=sm['controlsState'].personality)
