...
class LongitudinalPlanner:
  ...
  def update(self, sm):
    ...
    self.mpc.update(sm['radarState'], sm['hpilotPlan'].vCruise, x, v, a, j, sm['hpilotPlan'].tFollow, sm['hpilotCarControl'].trafficModeActive, personality=sm['controlsState'].personality)
