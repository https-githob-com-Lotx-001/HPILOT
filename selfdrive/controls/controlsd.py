...
class Controls:
  ...
  def state_control(self, CS):
    ...
    CC.latActive = (self.active or self.HPCC.alwaysOnLateral) and self.speed_check and not CS.steerFaultTemporary and not CS.steerFaultPermanent and \
  ...
  def update_hpilot_variables(self, CS):
    ...
    self.HPCC.alwaysOnLateral &= self.speed_check
  ...
  def update_hpilot_params(self):
    ...
    self.hpilot_variables.custom_cruise_increase_long = self.params.get_int("CustomCruiseLong") if quality_of_life else 5
